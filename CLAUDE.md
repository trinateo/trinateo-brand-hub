...
TrinaTeo Brand Hub — a personal brand website and content management tool for TrinaTeo.com that publishes services, thought leadership, case studies, and speaking engagements, and converts visitors into qualified enquiries.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238501244+trinateo@users.noreply.github.com"
  git config user.name "trinateo"
  ```
